...
"Hako Token" plays the role of "gold / assets" in this system and "credit to Hako" plays the role of "convertible note / currency" among the members. Members can transfer it to other members and they can also lend it to other members. About the exact functions, I tell you in the next.
...
This is the same function as "transfer" of ERC20. As its name suggests, transfer credit( to Hako) to other member.
...
This is the function that one member lends some credit( to Hako) to other member for a certain duration. 
...
Why?  
If she borrows 100 credit from other member and she can withdraw 700 token from Hako, there is a possibility that she runs away without returning her debt to Bob! So, the member who has debt to Other Member can't withdraw token.
...
This debt reduction is the opposite of credit creation. Credit creation is the operation to increase member's credit and debt and increase hako's credit and debt. In contrast, this is the operation to decrease member's credit and debt and decrease hako's credit and debt.
